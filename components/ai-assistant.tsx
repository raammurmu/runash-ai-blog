      ...
      <Dialog open={isOpen} onOpenChange={setIsOpen}>
        <DialogTrigger asChild>
          <Button
            ...
            className={cn(
              "h-14 w-14 rounded-full shadow-2xl transition-all focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2",
              isOpen ? "bg-muted text-foreground rotate-90 ring-2 ring-ring ring-offset-2" : "bg-orange-500"
            )}
          >
        ...
        <DialogContent className="bottom-24 left-auto right-6 top-auto w-[90vw] max-w-[400px] translate-x-0 translate-y-0 border-none bg-transparent p-0 shadow-none sm:rounded-none">
          <Card className="border-primary/20 overflow-hidden backdrop-blur-lg bg-background/95 shadow-2xl">
